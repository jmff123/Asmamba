...
from .uper_head_dict import UPerHeadDict
from .uper_head_dict_enhanced import UPerHeadDictEnhanced
from .vpd_depth_head import VPDDepthHead

__all__ = [
    'FCNHead', 'PSPHead', 'ASPPHead', 'PSAHead', 'NLHead', 'GCHead', 'CCHead',
    'UPerHead', 'UPerHeadDict', 'UPerHeadDictEnhanced', 'DepthwiseSeparableASPPHead', 'ANNHead', 'DAHead', 'OCRHead',
